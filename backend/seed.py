...
def _seed_organization_and_users(db):
    ...
    users = {
        ...
        "validator": User(
            organization_id=org.id,
            name="Eng. Ana Validadora",
            email="validador@atlas.demo",
...
def _seed_construction_management(db, org, engineer, project1):
    eap_items = [
        EAPItem(
            ...
            project_id=project1.id,
            code="1.0",
            name="1. Serviços Preliminares e Canteiro",
        ...
        EAPItem(
            ...
            project_id=project1.id,
            code="2.0",
            name="2. Infraestrutura e Fundações",
        ...
        EAPItem(
            ...
            project_id=project1.id,
            code="3.0",
            name="3. Supraestrutura e Alvenaria",
