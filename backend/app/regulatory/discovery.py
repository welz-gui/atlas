...
SOURCES: dict[str, tuple[DiscoverySource, ...]] = {
    "BR": (
        ...
        DiscoverySource(
            jurisdiction="BR",
            url=(
                "https://www.planalto.gov.br/ccivil_03/_ato2015-2018/2015/"
                "lei/l13146.htm"
            ),
            issuing_body="Presidência da República",
            allowed_hosts=("planalto.gov.br", "www.planalto.gov.br"),
    ...
    "BR-RS-4301008": (
        DiscoverySource(
            ...
            allowed_hosts=(
                "arroiodomeio.rs.gov.br",
                "www.arroiodomeio.rs.gov.br",
                "cespro.com.br",
                "www.cespro.com.br",
            ),
            known_documents=(
                DiscoveredDocument(
                    ...
                    url=(
                        "https://arroiodomeio.rs.gov.br/uploads/midia/16431/"
                        "LEI_N_2493_2006_Cdigo_de_edificaes.pdf"
                    ),
                    doc_type="lei",
                    number="2.493/2006",
                    theme="edificações",
                ...
                DiscoveredDocument(
                    ...
                    url=(
                        "https://arroiodomeio.rs.gov.br/uploads/midia/16430/"
                        "LEI_N_2491_2006_Parcelamento_do_solo_urbano.pdf"
                    ),
                    doc_type="lei",
                    number="2.491/2006",
                    theme="parcelamento do solo",
                ),
                DiscoveredDocument(
                    title=(
                        "Lei nº 3.269/2014 — Altera o Parcelamento do Solo Urbano"
                    ),
                    url=(
                        "https://arroiodomeio.rs.gov.br/uploads/midia/16432/"
                        "LEI_N_3269_2014_Parcelamento_do_solo_urbano.pdf"
                    ),
                    doc_type="lei",
                    number="3.269/2014",
                    theme="parcelamento do solo",
...
def discover_applicable_regulations(
    ...
    return {
        ...
        "sources_checked": [
            source for result in results for source in result["sources_checked"]
        ],
        "sources_skipped": [
            source for result in results for source in result["sources_skipped"]
        ],
        ...
        "document_ids": [
            document_id for result in results for document_id in result["document_ids"]
        ],
        "requires_human_validation": True,
    }
